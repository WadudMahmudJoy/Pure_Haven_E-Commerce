...
const backupDir = path.join(root, "_phase11c_backup_admin_orders_ux");
...
if (!existsSync(fullPath)) {
  throw new Error("app/admin/orders/page.tsx not found.");
}

copyFileSync(fullPath, path.join(backupDir, "app__admin__orders__page.tsx"));
...
console.log("Phase 11C applied: admin order UX cleaned up.");
console.log("Voucher hidden for pending/cancelled orders.");
console.log("Status update now requires Update Status button.");
console.log("Cancel Order uses confirmation.");
